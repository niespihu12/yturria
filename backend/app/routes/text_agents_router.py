...
async def upsert_provider_config(
    ...
    return await TextAgentController.upsert_provider_config(
        provider,
        payload,
        current_user,
        session,
...
@text_agents_router.post("/knowledge-base/text")
async def create_knowledge_base_document_from_text(
    ...
    payload = await request.json()
    return await TextAgentController.create_knowledge_base_document_from_text(
        payload,
        current_user,
        session,
    )
...
@text_agents_router.post("/knowledge-base/url")
async def create_knowledge_base_document_from_url(
    ...
    payload = await request.json()
    return await TextAgentController.create_knowledge_base_document_from_url(
        payload,
        current_user,
        session,
    )
...
@text_agents_router.patch("/knowledge-base/{document_id}")
async def update_knowledge_base_document(
    ...
    payload = await request.json()
    return await TextAgentController.update_knowledge_base_document(
        document_id,
        payload,
        current_user,
        session,
...
async def delete_knowledge_base_document(
    ...
    return await TextAgentController.delete_knowledge_base_document(
        document_id,
        current_user,
        session,
    )
...
async def list_agent_knowledge_base(
    ...
    return await TextAgentController.list_agent_knowledge_base(
        text_agent_id,
        current_user,
        session,
    )
...
async def get_text_conversation_detail(
    ...
    return await TextAgentController.get_conversation_detail(
        conversation_id,
        current_user,
        session,
    )
